...
$address = '1161-2115 No Pone Valley Road Northwest, Georgetown, TN 37336, USA';
//$address = 'Service Road, Kamra Kalan, Pakistan';

$coords = $geoplugin->getCoordinatesFromAddress($address);
echo "Geolocation results for address: {$address}: <br />\n".
...
$nearby = $geoplugin->nearby($coords['latitude'], $coords['longitude'], 100, 999999999);

if ( isset($nearby[0]['geoplugin_place']) ) {

	echo "<pre><p>Some places you may wish to visit near you </p>\n";
...
exit;
$distance = $geoplugin->getDistanceBetween( 33.8679925, 72.4315953, 33.440826, 72.014635 );
echo "Distance in KMs: " . $distance . "<br />";
$distance = $geoplugin->convertKmstoMiles($distance);
if( $distance < 50 ) {
    echo 'fall within the 50 miles radius:'.$distance;
} else {
    echo 'It\'s beyond 50 miles radius';
}
